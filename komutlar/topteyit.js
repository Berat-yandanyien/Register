...
if(!message.member.roles.cache.some(r => [,"764893503934300160","764893501329637396","794285242974208020"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
