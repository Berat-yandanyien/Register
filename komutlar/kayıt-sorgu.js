...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["787937477993955368", "764893494296051723","764893503934300160","764893501329637396",'764893484213075970','794285242974208020'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
 ...
 if(!kullanıcı) {
    ...
    .setDescription(`<:ERKEK:793076734610112553> • Toplam Erkek Kayıtların: \`${erkek}\`
    
    <:Kadn:793076917342437396> • Toplam Kadın Kayıtların: \`${kadın}\`
    
    <:PremiumPng:793080683563319308> • Toplam Kayıtlar:  \`${kayıtlar}\` 
    `)
    .setColor("0x2f3136")
...
.setDescription(`<:PremiumPng:793080683563319308> • Toplam Kayıtların: \`${kayıtlar1}\`
<:ERKEK:793076734610112553> • Toplam Erkek Kayıtların: \`${erkek1}\`
<:Kadn:793076917342437396> • Toplam Kadın Kayıtların: \`${kadin1}\`
`)
.setColor("0x2f3136")
